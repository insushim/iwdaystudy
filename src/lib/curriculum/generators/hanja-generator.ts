...
const GRADE_3_4_HANJA: HanjaData[] = [
  ...
  // ── Actions (추가) ──
  { character: "打", reading: "타", meaning: "칠 타", strokes: 6, words: ["타격", "타자", "타악기"], sentence: "공을 세게 쳤다." },
  { character: "持", reading: "지", meaning: "가질 지", strokes: 10, words: ["소지", "유지", "지속"], sentence: "책을 손에 들고 있다." },
  { character: "拾", reading: "습", meaning: "주울 습", strokes: 10, words: ["습득", "수습", "주워"], sentence: "길에서 동전을 주웠다." },
  { character: "投", reading: "투", meaning: "던질 투", strokes: 8, words: ["투구", "투표", "투입"], sentence: "공을 멀리 던졌다." },
  { character: "押", reading: "압", meaning: "누를 압", strokes: 9, words: ["압력", "압박", "기압"], sentence: "버튼을 세게 눌렀다." },
  { character: "引", reading: "인", meaning: "끌 인", strokes: 4, words: ["인도", "인력", "견인"], sentence: "줄을 세게 잡아당겼다." },
  { character: "切", reading: "절", meaning: "끊을 절", strokes: 4, words: ["절단", "절약", "일절"], sentence: "종이를 반으로 잘랐다." },
  { character: "落", reading: "락", meaning: "떨어질 락", strokes: 13, words: ["낙하", "낙엽", "탈락"], sentence: "나뭇잎이 떨어졌다." },
  { character: "登", reading: "등", meaning: "오를 등", strokes: 12, words: ["등산", "등교", "등록"], sentence: "산을 힘차게 올랐다." },
  { character: "送", reading: "송", meaning: "보낼 송", strokes: 10, words: ["전송", "방송", "송별"], sentence: "편지를 부모님께 보냈다." },
  // ── 수량/정도 (추가) ──
  { character: "寸", reading: "촌", meaning: "마디 촌", strokes: 3, words: ["촌수", "일촌", "치수"], sentence: "친척 간의 촌수를 배웠다." },
  { character: "尺", reading: "척", meaning: "자 척", strokes: 4, words: ["척도", "자", "축척"], sentence: "자로 길이를 재었다." },
  { character: "量", reading: "량", meaning: "헤아릴 량", strokes: 12, words: ["수량", "용량", "측량"], sentence: "물의 양을 정확히 재었다." },
  { character: "丁", reading: "정", meaning: "고무래 정", strokes: 2, words: ["정원", "일정", "장정"], sentence: "넷째 줄 정(丁)자를 배웠다." },
  // ── 집/건물 (추가) ──
  { character: "宿", reading: "숙", meaning: "잘 숙", strokes: 11, words: ["숙소", "민숙", "숙박"], sentence: "여행 중 숙소에 머물렀다." },
  { character: "院", reading: "원", meaning: "집 원", strokes: 10, words: ["병원", "학원", "법원"], sentence: "병원에서 치료를 받았다." },
  { character: "堂", reading: "당", meaning: "집 당", strokes: 11, words: ["식당", "강당", "당당"], sentence: "강당에서 졸업식을 했다." },
  { character: "宅", reading: "택", meaning: "집 택", strokes: 6, words: ["자택", "주택", "택지"], sentence: "새 주택으로 이사했다." },
  // ── 학교 관련 (추가) ──
  { character: "答", reading: "답", meaning: "대답할 답", strokes: 12, words: ["대답", "정답", "답장"], sentence: "질문에 정확하게 대답했다." },
  { character: "問", reading: "문", meaning: "물을 문", strokes: 11, words: ["질문", "문제", "의문"], sentence: "선생님께 궁금한 것을 질문했다." },
  { character: "考", reading: "고", meaning: "생각할 고", strokes: 6, words: ["사고", "참고", "고민"], sentence: "깊이 생각하고 답을 골랐다." },
  { character: "試", reading: "시", meaning: "시험할 시", strokes: 13, words: ["시험", "시도", "시합"], sentence: "수학 시험을 잘 봤다." },
  { character: "題", reading: "제", meaning: "제목 제", strokes: 18, words: ["문제", "제목", "주제"], sentence: "어려운 문제를 풀었다." },
  // ── 감정/상태 (추가) ──
  { character: "喜", reading: "희", meaning: "기쁠 희", strokes: 12, words: ["기쁨", "희극", "희망"], sentence: "상을 받아서 기뻤다." },
  { character: "怒", reading: "노", meaning: "성낼 노", strokes: 9, words: ["분노", "노여움", "격노"], sentence: "화가 나도 참는 것이 좋다." },
  { character: "哀", reading: "애", meaning: "슬플 애", strokes: 9, words: ["슬픔", "애도", "비애"], sentence: "슬픈 영화를 보고 울었다." },
  { character: "樂", reading: "낙", meaning: "즐길 낙", strokes: 15, words: ["낙관", "안락", "낙천"], sentence: "즐거운 마음으로 하루를 보냈다." },
  { character: "望", reading: "망", meaning: "바랄 망", strokes: 11, words: ["희망", "소망", "전망"], sentence: "꿈을 이루기를 소망한다." },
  { character: "恐", reading: "공", meaning: "두려울 공", strokes: 10, words: ["공포", "공룡", "공황"], sentence: "귀신 이야기를 들으니 무서웠다." },
  { character: "感", reading: "감", meaning: "느낄 감", strokes: 13, words: ["감동", "감사", "감정"], sentence: "아름다운 노래에 감동했다." },
  // ── 도구/생활 (추가) ──
  { character: "鏡", reading: "경", meaning: "거울 경", strokes: 19, words: ["거울", "안경", "망원경"], sentence: "거울을 보고 머리를 빗었다." },
  { character: "傘", reading: "산", meaning: "우산 산", strokes: 12, words: ["우산", "양산", "산하"], sentence: "비가 와서 우산을 폈다." },
  { character: "鐘", reading: "종", meaning: "종 종", strokes: 20, words: ["시종", "종소리", "타종"], sentence: "학교 종이 땡땡 울렸다." },
  { character: "旗", reading: "기", meaning: "깃발 기", strokes: 14, words: ["국기", "깃발", "기수"], sentence: "태극기를 높이 달았다." },
  { character: "歌", reading: "가", meaning: "노래 가", strokes: 14, words: ["노래", "가수", "가요"], sentence: "음악 시간에 노래를 불렀다." },
  { character: "圖", reading: "도", meaning: "그림 도", strokes: 14, words: ["지도", "도서관", "그림"], sentence: "지도를 보고 방향을 찾았다." },
  // ── 기타 기초 (추가) ──
  { character: "色", reading: "색", meaning: "빛 색", strokes: 6, words: ["원색", "황색", "변색"], sentence: "빨강, 파랑, 노랑은 삼원색이다." },
  { character: "光", reading: "광", meaning: "빛 광", strokes: 6, words: ["광선", "햇빛", "광명"], sentence: "밝은 빛이 교실을 비추었다." },
  { character: "聲", reading: "성", meaning: "소리 성", strokes: 17, words: ["음성", "성원", "목소리"], sentence: "친구의 큰 목소리가 들렸다." },
  { character: "味", reading: "미", meaning: "맛 미", strokes: 8, words: ["맛", "의미", "흥미"], sentence: "엄마가 만든 음식 맛이 좋다." },
  { character: "形", reading: "형", meaning: "모양 형", strokes: 7, words: ["삼각형", "형태", "도형"], sentence: "여러 가지 도형을 배웠다." },
  { character: "計", reading: "계", meaning: "셀 계", strokes: 9, words: ["시계", "계산", "합계"], sentence: "시계를 보고 시간을 알았다." },
  { character: "信", reading: "신", meaning: "믿을 신", strokes: 9, words: ["신뢰", "자신", "편지"], sentence: "친구를 믿는 마음이 중요하다." },
  { character: "祝", reading: "축", meaning: "빌 축", strokes: 10, words: ["축하", "축제", "축복"], sentence: "생일을 축하해 주었다." },
  { character: "禮", reading: "례", meaning: "예도 례", strokes: 18, words: ["예절", "인사", "예의"], sentence: "어른께 바르게 인사했다." },
  { character: "記", reading: "기", meaning: "기록할 기", strokes: 10, words: ["일기", "기록", "기억"], sentence: "매일 일기를 쓴다." },
  { character: "語", reading: "어", meaning: "말씀 어", strokes: 14, words: ["언어", "한국어", "어학"], sentence: "한국어를 사랑한다." },
  { character: "頭", reading: "두", meaning: "머리 두", strokes: 16, words: ["두뇌", "선두", "두통"], sentence: "공부를 많이 하면 머리가 좋아진다." },
  { character: "顔", reading: "안", meaning: "얼굴 안", strokes: 18, words: ["안색", "용안", "안면"], sentence: "웃는 얼굴이 예쁘다." },
  // ──── 추가: 8급 기초 한자 (30) ────
  { character: "色", reading: "색", meaning: "빛 색", strokes: 6, words: ["색깔", "특색", "경색"], sentence: "무지개는 일곱 가지 색으로 이루어져 있다." },
  { character: "白", reading: "백", meaning: "흰 백", strokes: 5, words: ["백색", "공백", "백발"], sentence: "하얀 눈이 내렸다." },
  { character: "黑", reading: "흑", meaning: "검을 흑", strokes: 12, words: ["흑색", "흑인", "암흑"], sentence: "밤하늘이 까맣다." },
  { character: "靑", reading: "청", meaning: "푸를 청", strokes: 8, words: ["청소년", "청춘", "청색"], sentence: "푸른 하늘이 아름답다." },
  { character: "赤", reading: "적", meaning: "붉을 적", strokes: 7, words: ["적색", "적도", "적자"], sentence: "빨간 태양이 떠올랐다." },
  { character: "正", reading: "정", meaning: "바를 정", strokes: 5, words: ["정답", "정직", "교정"], sentence: "정답을 맞히니 기분이 좋다." },
  { character: "直", reading: "직", meaning: "곧을 직", strokes: 8, words: ["정직", "직선", "직접"], sentence: "정직한 사람이 되자." },
  { character: "善", reading: "선", meaning: "착할 선", strokes: 12, words: ["선행", "선량", "최선"], sentence: "착한 일을 많이 하자." },
  { character: "惡", reading: "악", meaning: "악할 악", strokes: 12, words: ["악인", "악행", "악화"], sentence: "나쁜 일은 하지 말자." },
  { character: "安", reading: "안", meaning: "편안할 안", strokes: 6, words: ["안전", "안심", "안정"], sentence: "안전하게 생활하자." },
  { character: "危", reading: "위", meaning: "위태로울 위", strokes: 6, words: ["위험", "위기", "위급"], sentence: "위험한 곳에 가지 말자." },
  { character: "全", reading: "전", meaning: "온전할 전", strokes: 6, words: ["전체", "안전", "완전"], sentence: "전교생이 운동장에 모였다." },
  { character: "半", reading: "반", meaning: "반 반", strokes: 5, words: ["반달", "반반", "전반"], sentence: "사과를 반으로 잘랐다." },
  { character: "百", reading: "백", meaning: "일백 백", strokes: 6, words: ["백점", "백년", "백성"], sentence: "시험에서 백점을 받았다." },
  { character: "千", reading: "천", meaning: "일천 천", strokes: 3, words: ["천원", "천리", "천자"], sentence: "천 원짜리 동전을 모았다." },
  { character: "萬", reading: "만", meaning: "일만 만", strokes: 13, words: ["만원", "만세", "만물"], sentence: "만물이 봄에 살아난다." },
  { character: "億", reading: "억", meaning: "억 억", strokes: 15, words: ["억원", "수억", "기억"], sentence: "기억력이 좋으면 공부에 도움이 된다." },
  { character: "長", reading: "장", meaning: "길 장", strokes: 8, words: ["장점", "성장", "학교장"], sentence: "키가 많이 자랐다." },
  { character: "短", reading: "단", meaning: "짧을 단", strokes: 12, words: ["단점", "단축", "단거리"], sentence: "단점을 고치려고 노력한다." },
  { character: "高", reading: "고", meaning: "높을 고", strokes: 10, words: ["고층", "최고", "고지대"], sentence: "산 꼭대기가 높다." },
  { character: "低", reading: "저", meaning: "낮을 저", strokes: 7, words: ["저지대", "최저", "저학년"], sentence: "올해 최저 기온이 기록되었다." },
  { character: "多", reading: "다", meaning: "많을 다", strokes: 6, words: ["다수", "다양", "다행"], sentence: "여러 가지 색이 다양하다." },
  { character: "少", reading: "소", meaning: "적을 소", strokes: 4, words: ["소수", "적소", "소량"], sentence: "적은 양으로도 맛있는 요리를 만들 수 있다." },
  { character: "新", reading: "신", meaning: "새 신", strokes: 13, words: ["신문", "새해", "혁신"], sentence: "새해에 새로운 목표를 세웠다." },
  { character: "古", reading: "고", meaning: "예 고", strokes: 5, words: ["고대", "고전", "고궁"], sentence: "고궁에서 역사를 배웠다." },
  { character: "老", reading: "노", meaning: "늙을 노", strokes: 6, words: ["노인", "노력", "양로원"], sentence: "어른을 공경하는 것이 예절이다." },
  { character: "幼", reading: "유", meaning: "어릴 유", strokes: 5, words: ["유치원", "유아", "유년"], sentence: "유치원 시절이 그립다." },
  { character: "音", reading: "음", meaning: "소리 음", strokes: 9, words: ["음악", "발음", "음성"], sentence: "아름다운 음악을 들었다." },
  { character: "色", reading: "색", meaning: "빛 색", strokes: 6, words: ["색상", "경색", "특색"], sentence: "가을 단풍의 색이 아름답다." },
  { character: "味", reading: "미", meaning: "맛 미", strokes: 8, words: ["맛", "의미", "흥미"], sentence: "김치의 맛이 맵고 시원하다." },
];
...
const GRADE_5_6_HANJA: HanjaData[] = [
  ...
  // ── 교육/학문 (추가) ──
  { character: "育", reading: "육", meaning: "기를 육", strokes: 8, words: ["교육", "체육", "육아"], sentence: "교육은 미래를 밝히는 열쇠이다." },
  { character: "養", reading: "양", meaning: "기를 양", strokes: 15, words: ["영양", "양육", "교양"], sentence: "균형 잡힌 영양 섭취가 중요하다." },
  { character: "講", reading: "강", meaning: "말씀할 강", strokes: 17, words: ["강의", "강연", "강좌"], sentence: "선생님의 강의가 재미있었다." },
  { character: "師", reading: "사", meaning: "스승 사", strokes: 10, words: ["교사", "의사", "사범"], sentence: "훌륭한 스승을 만나 감사했다." },
  { character: "博", reading: "박", meaning: "넓을 박", strokes: 12, words: ["박물관", "박사", "박학"], sentence: "박물관에서 역사를 배웠다." },
  { character: "識", reading: "식", meaning: "알 식", strokes: 19, words: ["지식", "인식", "의식"], sentence: "지식을 쌓으면 세상이 넓어진다." },
  // ── 시간/기간 (추가) ──
  { character: "古", reading: "고", meaning: "옛 고", strokes: 5, words: ["고대", "고전", "태고"], sentence: "고대 문명에 대해 공부했다." },
  { character: "今", reading: "금", meaning: "이제 금", strokes: 4, words: ["금일", "지금", "금년"], sentence: "지금 이 순간을 소중히 여기자." },
  { character: "昔", reading: "석", meaning: "옛 석", strokes: 8, words: ["옛날", "석양", "금석"], sentence: "옛날이야기를 할머니께서 들려주셨다." },
  { character: "暦", reading: "력", meaning: "달력 력", strokes: 14, words: ["달력", "양력", "음력"], sentence: "달력을 보고 공휴일을 확인했다." },
  { character: "紀", reading: "기", meaning: "벼리 기", strokes: 9, words: ["세기", "기원", "기념"], sentence: "21세기는 기술의 시대이다." },
  { character: "代", reading: "대", meaning: "대신할 대", strokes: 5, words: ["시대", "대표", "세대"], sentence: "새로운 시대가 시작되었다." },
  // ── 정치/통치 (추가) ──
  { character: "憲", reading: "헌", meaning: "법 헌", strokes: 16, words: ["헌법", "합헌", "위헌"], sentence: "헌법은 나라의 기본 법이다." },
  { character: "權", reading: "권", meaning: "권세 권", strokes: 22, words: ["권리", "인권", "권력"], sentence: "모든 사람에게 인권이 있다." },
  { character: "選", reading: "선", meaning: "가릴 선", strokes: 15, words: ["선거", "선택", "당선"], sentence: "반장 선거에서 투표했다." },
  { character: "投", reading: "투", meaning: "던질 투", strokes: 8, words: ["투표", "투자", "투입"], sentence: "선거에서 한 표를 행사했다." },
  { character: "票", reading: "표", meaning: "표 표", strokes: 11, words: ["투표", "표결", "입장표"], sentence: "투표용지에 기표했다." },
  { character: "約", reading: "약", meaning: "맺을 약", strokes: 9, words: ["약속", "조약", "계약"], sentence: "친구와 약속을 지켰다." },
  { character: "規", reading: "규", meaning: "법 규", strokes: 11, words: ["규칙", "규모", "규정"], sentence: "교통 규칙을 잘 지키자." },
  { character: "則", reading: "칙", meaning: "법칙 칙", strokes: 9, words: ["규칙", "법칙", "원칙"], sentence: "자연의 법칙을 공부했다." },
  // ── 추상 개념 (추가) ──
  { character: "眞", reading: "진", meaning: "참 진", strokes: 10, words: ["진실", "진리", "진짜"], sentence: "진실을 말하는 것이 중요하다." },
  { character: "僞", reading: "위", meaning: "거짓 위", strokes: 14, words: ["거짓", "위조", "위선"], sentence: "거짓말은 하지 말아야 한다." },
  { character: "誠", reading: "성", meaning: "정성 성", strokes: 14, words: ["정성", "성실", "진성"], sentence: "정성을 다해 일하면 좋은 결과가 온다." },
  { character: "賢", reading: "현", meaning: "어질 현", strokes: 15, words: ["현명", "현인", "성현"], sentence: "현명한 판단으로 문제를 해결했다." },
  { character: "勤", reading: "근", meaning: "부지런할 근", strokes: 13, words: ["근면", "출근", "근무"], sentence: "부지런히 노력하는 사람이 성공한다." },
  { character: "忍", reading: "인", meaning: "참을 인", strokes: 7, words: ["인내", "참을", "인동"], sentence: "어려움을 참고 이겨냈다." },
  { character: "耐", reading: "내", meaning: "견딜 내", strokes: 9, words: ["인내", "내구", "내열"], sentence: "끝까지 견뎌낸 사람이 승리한다." },
  { character: "謙", reading: "겸", meaning: "겸손할 겸", strokes: 17, words: ["겸손", "겸양", "겸허"], sentence: "겸손한 태도로 배움을 구하자." },
  // ── 자연/지리 (추가) ──
  { character: "災", reading: "재", meaning: "재앙 재", strokes: 7, words: ["재난", "천재", "화재"], sentence: "자연재해에 대비해야 한다." },
  { character: "害", reading: "해", meaning: "해칠 해", strokes: 10, words: ["피해", "해로", "재해"], sentence: "태풍 피해를 복구했다." },
  { character: "汚", reading: "오", meaning: "더러울 오", strokes: 7, words: ["오염", "오물", "오수"], sentence: "강물이 오염되지 않도록 주의하자." },
  { character: "染", reading: "염", meaning: "물들일 염", strokes: 9, words: ["오염", "염색", "감염"], sentence: "환경 오염을 줄이기 위해 노력하자." },
  { character: "暑", reading: "서", meaning: "더울 서", strokes: 13, words: ["더위", "서기", "피서"], sentence: "여름 더위를 피해 계곡에 갔다." },
  { character: "寒", reading: "한", meaning: "추울 한", strokes: 12, words: ["추위", "한파", "한대"], sentence: "겨울 추위에 따뜻하게 입자." },
  { character: "暖", reading: "난", meaning: "따뜻할 난", strokes: 13, words: ["온난", "난방", "따뜻"], sentence: "봄이 오면 날씨가 따뜻해진다." },
  // ── 경제/사회 (추가) ──
  { character: "稅", reading: "세", meaning: "세금 세", strokes: 12, words: ["세금", "면세", "납세"], sentence: "세금으로 나라 살림을 운영한다." },
  { character: "財", reading: "재", meaning: "재물 재", strokes: 10, words: ["재산", "재정", "재물"], sentence: "재물보다 건강이 더 중요하다." },
  { character: "富", reading: "부", meaning: "부유할 부", strokes: 12, words: ["부자", "풍부", "부유"], sentence: "마음이 풍부한 사람이 진정한 부자이다." },
  { character: "貧", reading: "빈", meaning: "가난할 빈", strokes: 11, words: ["가난", "빈곤", "빈민"], sentence: "어려운 이웃을 도와주자." },
  { character: "輸", reading: "수", meaning: "보낼 수", strokes: 16, words: ["수출", "수입", "운수"], sentence: "좋은 상품을 해외로 수출한다." },
  // ── 인체/건강 (추가) ──
  { character: "腦", reading: "뇌", meaning: "뇌 뇌", strokes: 13, words: ["두뇌", "뇌파", "뇌수"], sentence: "두뇌를 활발히 쓰면 똑똑해진다." },
  { character: "肺", reading: "폐", meaning: "허파 폐", strokes: 9, words: ["폐렴", "폐활량", "심폐"], sentence: "깊은 숨을 쉬면 폐 건강에 좋다." },
  { character: "胃", reading: "위", meaning: "밥통 위", strokes: 9, words: ["위장", "위산", "위염"], sentence: "음식을 꼭꼭 씹어 먹으면 위에 좋다." },
  { character: "筋", reading: "근", meaning: "힘줄 근", strokes: 12, words: ["근육", "근력", "철근"], sentence: "운동하면 근육이 강해진다." },
  { character: "骨", reading: "골", meaning: "뼈 골", strokes: 10, words: ["골격", "뼈", "골절"], sentence: "칼슘을 섭취하면 뼈가 튼튼해진다." },
  // ── 문화/예술 (추가) ──
  { character: "詩", reading: "시", meaning: "시 시", strokes: 13, words: ["시인", "동시", "한시"], sentence: "아름다운 시를 읽으며 감동했다." },
  { character: "歌", reading: "가", meaning: "노래 가", strokes: 14, words: ["가수", "노래", "가요"], sentence: "가수가 무대에서 노래했다." },
  { character: "舞", reading: "무", meaning: "춤 무", strokes: 14, words: ["무용", "춤", "무대"], sentence: "발표회에서 춤을 추었다." },
  { character: "畵", reading: "화", meaning: "그림 화", strokes: 12, words: ["회화", "만화", "그림"], sentence: "미술관에서 멋진 그림을 감상했다." },
  { character: "館", reading: "관", meaning: "집 관", strokes: 16, words: ["도서관", "박물관", "미술관"], sentence: "박물관에서 전시를 관람했다." },
];
...
const HANJA_34_X: [string,string,string,number,string,string][] = [
  ...
  ['氣','기','기운',10,'기운,공기,날씨','기운 기(氣)는 에너지를 뜻합니다.'],
  ...
  ['樂','악','음악',15,'음악,즐거움,쾌락','풍류 악(樂)은 음악을 뜻합니다.'],
  ['問','문','물을',11,'질문,문제,방문','물을 문(問)은 묻는 것입니다.'],
  ['答','답','대답',12,'대답,답변,정답','대답 답(答)은 답하는 것입니다.'],
  ['老','노','늙은',6,'노인,노력,양로원','늙을 노(老)는 나이 든 것입니다.'],
  ...
  ['弱','약','약한',10,'약점,약한,허약','약할 약(弱)은 힘이 약한 것입니다.'],
  ['善','선','착한',12,'선행,선의,친선','착할 선(善)은 착한 것입니다.'],
  ['惡','악','나쁜',12,'악인,악행,악의','나쁠 악(惡)은 나쁜 것입니다.'],
  // ── Additional 100+ entries ──
  ['姉','자','손윗누이',8,'자매,장자,자형','손윗누이 자(姉)는 언니를 뜻합니다.'],
  ['妹','매','누이',8,'자매,매형,매제','누이 매(妹)는 여동생을 뜻합니다.'],
  ['夫','부','지아비',4,'부부,장부,부인','지아비 부(夫)는 남편을 뜻합니다.'],
  ['婦','부','며느리',11,'부부,주부,부인','며느리 부(婦)는 아내를 뜻합니다.'],
  ['祖','조','할아버지',10,'조상,조부,선조','할아버지 조(祖)는 조상을 뜻합니다.'],
  ['孫','손','손자',10,'손자,자손,손녀','손자 손(孫)은 손자를 뜻합니다.'],
  ['親','친','친할',16,'부친,친구,친절','친할 친(親)은 가까움을 뜻합니다.'],
  ['兒','아','아이',8,'아이,유아,아동','아이 아(兒)는 어린이를 뜻합니다.'],
  ['童','동','아이',12,'아동,동심,동화','아이 동(童)은 어린이를 뜻합니다.'],
  ...
  ['涼','량','서늘할',11,'서늘,양량,청량','서늘할 량(涼)은 시원한 것입니다.'],
  ['暖','난','따뜻할',13,'온난,따뜻,난방','따뜻할 난(暖)은 따뜻한 것입니다.'],
  ['晴','청','갤',12,'맑음,청천,쾌청','갤 청(晴)은 맑은 날씨입니다.'],
  ['曇','담','흐릴',16,'흐림,담천,운담','흐릴 담(曇)은 흐린 날씨입니다.'],
  ['朔','삭','초하루',10,'삭일,삭풍,삭월','초하루 삭(朔)은 달의 첫날입니다.'],
  ...
  ['圓','원','둥글',13,'원형,원만,동그라미','둥글 원(圓)은 둥근 것입니다.'],
  ['線','선','줄',15,'직선,노선,전선','줄 선(線)은 줄을 뜻합니다.'],
  ['點','점','점',17,'점수,시점,결점','점 점(點)은 점을 뜻합니다.'],
  ['面','면','낯',9,'표면,면적,정면','낯 면(面)은 얼굴이나 면을 뜻합니다.'],
  ['邊','변','가',18,'주변,변두리,해변','가 변(邊)은 가장자리를 뜻합니다.'],
  ...
  ['聲','성','소리',17,'음성,성원,목소리','소리 성(聲)은 소리를 뜻합니다.'],
  ['響','향','울릴',22,'영향,반향,음향','울릴 향(響)은 울리는 소리입니다.'],
  ['香','향','향기',9,'향기,향수,방향','향기 향(香)은 좋은 냄새입니다.'],
  ['匹','필','짝',4,'한필,필적,필마','짝 필(匹)은 짝을 뜻합니다.'],
  ['峰','봉','봉우리',10,'산봉,봉우리,최고봉','봉우리 봉(峰)은 산꼭대기입니다.'],
  ['岩','암','바위',8,'암석,바위,암벽','바위 암(岩)은 바위를 뜻합니다.'],
  ['坂','판','비탈',7,'비탈,판로,급판','비탈 판(坂)은 비탈길입니다.'],
  ['崖','애','낭떠러지',11,'절벽,애벽,단애','낭떠러지 애(崖)는 절벽입니다.'],
  ['泉','천','샘',9,'온천,약수,천수','샘 천(泉)은 샘물을 뜻합니다.'],
  ['沙','사','모래',8,'사막,모래,사장','모래 사(沙)는 모래를 뜻합니다.'],
  ['竹','죽','대나무',6,'대나무,죽림,죽순','대나무 죽(竹)은 대나무입니다.'],
  ['松','송','소나무',8,'소나무,송림,송화','소나무 송(松)은 소나무입니다.'],
  ...
  ['瓜','과','오이',5,'수박,오이,과일','오이 과(瓜)는 오이 종류를 뜻합니다.'],
...
const HANJA_56_X: [string,string,string,number,string,string][] = [
  ['義','의','옳을',13,'정의,의리,의무','옳을 의(義)는 올바름을 뜻합니다.'],
  ...
  ['孝','효','효도',7,'효도,효자,효과','효도 효(孝)는 부모를 섬기는 것입니다.'],
  ...
  ['政','정','정사',9,'정치,행정,정부','정사 정(政)은 나라 일을 뜻합니다.'],
  ...
  ['港','항','항구',12,'항구,공항,인천항','항구 항(港)은 배가 드는 곳입니다.'],
  ['都','도','도읍',11,'수도,도시,도청','도읍 도(都)는 도시를 뜻합니다.'],
  ['院','원','집',10,'병원,학원,법원','집 원(院)은 건물을 뜻합니다.'],
  ['館','관','집',16,'도서관,박물관,미술관','집 관(館)은 건물을 뜻합니다.'],
  ...
  ['富','부','부유할',12,'부자,풍부,부유','부유할 부(富)는 부유함을 뜻합니다.'],
  ['貧','빈','가난할',11,'가난,빈곤,빈민','가난할 빈(貧)은 가난을 뜻합니다.'],
  ...
  ['令','령','하여금',5,'명령,법령,사령','하여금 령(令)은 명령을 뜻합니다.'],
  ['征','정','칠',8,'원정,정벌,출정','칠 정(征)은 정벌을 뜻합니다.'],
  ['貿','무','무역할',12,'무역,외무,통무','무역할 무(貿)는 무역을 뜻합니다.'],
  ...
  ['確','확','확실할',15,'확인,확실,정확','확실할 확(確)은 확실함을 뜻합니다.'],
  ['認','인','알',14,'인정,확인,인식','알 인(認)은 인정을 뜻합니다.'],
  ['許','허','허락할',11,'허락,허가,허용','허락할 허(許)는 허락을 뜻합니다.'],
  ...
  ['翻','번','뒤집을',18,'번역,번복,뒤집기','뒤집을 번(翻)은 번역을 뜻합니다.'],
  ['譯','역','통역할',20,'번역,통역,역서','통역할 역(譯)은 번역을 뜻합니다.'],
  ...
  ['象','상','코끼리',12,'현상,기상,형상','코끼리 상(象)은 형상을 뜻합니다.'],
  ['災','재','재앙',7,'재난,천재,화재','재앙 재(災)는 재해를 뜻합니다.'],
  ['害','해','해칠',10,'피해,해로,재해','해칠 해(害)는 해를 뜻합니다.'],
  ['汚','오','더러울',7,'오염,더러움,오물','더러울 오(汚)는 더러움을 뜻합니다.'],
  ['染','염','물들일',9,'오염,염색,감염','물들일 염(染)은 물들이는 것입니다.'],
  ['純','순','순수할',10,'순수,순진,순서','순수할 순(純)은 순수함을 뜻합니다.'],
  ['粹','수','순수할',14,'순수,정수,국수','순수할 수(粹)는 깨끗함을 뜻합니다.'],
  ...
  ['診','진','진찰할',12,'진찰,진료,검진','진찰할 진(診)은 진찰을 뜻합니다.'],
  ['檢','검','검사할',17,'검사,검진,검토','검사할 검(檢)은 검사를 뜻합니다.'],
  ['查','사','조사할',9,'조사,검사,수사','조사할 사(查)는 조사를 뜻합니다.'],
  ...
  ['創','창','비롯할',12,'창조,창작,독창','비롯할 창(創)은 만드는 것입니다.'],
  ...
  ['效','효','본받을',10,'효과,유효,효율','본받을 효(效)는 효과를 뜻합니다.'],
  ['優','우','넉넉할',17,'우수,우대,우승','넉넉할 우(優)는 뛰어남을 뜻합니다.'],
  ['秀','수','빼어날',7,'우수,수재,수석','빼어날 수(秀)는 뛰어남을 뜻합니다.'],
  ['誠','성','정성',14,'정성,성실,진성','정성 성(誠)은 정성을 뜻합니다.'],
  ['眞','진','참',10,'진실,진리,진짜','참 진(眞)은 참을 뜻합니다.'],
  ['僞','위','거짓',14,'거짓,위조,위선','거짓 위(僞)는 거짓을 뜻합니다.'],
  ['賢','현','어질',15,'현명,현인,성현','어질 현(賢)은 어질고 현명함을 뜻합니다.'],
  ['壯','장','씩씩할',7,'장대,장관,장년','씩씩할 장(壯)은 씩씩함을 뜻합니다.'],
  ['嚴','엄','엄할',20,'엄격,장엄,위엄','엄할 엄(嚴)은 엄격함을 뜻합니다.'],
  ['慈','자','사랑할',13,'자비,자선,자애','사랑할 자(慈)는 자비를 뜻합니다.'],
  ['忍','인','참을',7,'인내,참을,인동','참을 인(忍)은 참는 것입니다.'],
  ['耐','내','견딜',9,'인내,내구,내열','견딜 내(耐)는 견디는 것입니다.'],
  ['謙','겸','겸손할',17,'겸손,겸양,겸허','겸손할 겸(謙)은 겸손을 뜻합니다.'],
  ['遜','손','겸손할',17,'겸손,손색,손양','겸손할 손(遜)은 겸손을 뜻합니다.'],
];
const EXTRA_34: HanjaData[] = HANJA_34_X.map(([character,reading,meaning,strokes,w,sentence]) => ({character,reading,meaning,strokes,words:w.split(','),sentence}));
const EXTRA_56: HanjaData[] = HANJA_56_X.map(([character,reading,meaning,strokes,w,sentence]) => ({character,reading,meaning,strokes,words:w.split(','),sentence}));
