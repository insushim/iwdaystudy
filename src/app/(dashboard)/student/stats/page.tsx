...
const subjectData = [
  ...
  { subject: "general_knowledge", name: "상식", accuracy: 88, color: "#F9CA24" },
...
const weakAreas = [
  { subject: "한자", topic: "4학년 한자 읽기", accuracy: 45, suggestion: "획순 연습을 더 해보세요" },
  { subject: "영어", topic: "기초 단어", accuracy: 55, suggestion: "매일 5개씩 외워보세요" },
  { subject: "어휘", topic: "반의어", accuracy: 60, suggestion: "짝을 지어서 외우면 좋아요" },
];
                ...
                <CardContent className="flex flex-col items-center">
                  ...
                  <div className="flex gap-6 mt-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-primary">{Math.round(totalSessions * 10 * overallAccuracy / 100)}</p>
                      <p className="text-xs text-muted-foreground">맞은 문제</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-muted-foreground">{Math.round(totalSessions * 10 * (100 - overallAccuracy) / 100)}</p>
                    ...
                    <ResponsiveContainer width="100%" height={280}>
                      <AreaChart data={weeklyPoints}>
                        ...
                        <Tooltip
                          ...
                          formatter={(value: number) => [`${value}P`, "획득 포인트"]}
                        />
                        <Area
                          type="monotone"
                          dataKey="points"
            ...
            >
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>정답률이 낮은 영역을 집중 연습해보세요</CardDescription>
                </CardHeader>
                    ...
                    <div key={idx} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">{area.subject} - {area.topic}</span>
                        </div>
