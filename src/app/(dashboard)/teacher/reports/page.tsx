              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={classPerformance}>
                    ...
                    />
                    <Area type="monotone" dataKey="avgScore" stroke="#2ECC71" fill="url(#scoreGrad)" strokeWidth={2} name="평균 점수" />
                    <Area type="monotone" dataKey="completion" stroke="#4ECDC4" fill="url(#completionGrad)" strokeWidth={2} name="완료율 (%)" />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
                    ...
                    <BarChart data={subjectAnalysis} margin={{ left: -10 }}>
                      ...
                      <Tooltip
                        ...
                        formatter={(value: number, name: string) => {
                          const label = name === "avg" ? "평균" : name === "highest" ? "최고" : "최저";
                          return [`${value}점`, label];
                        }}
                      />
                      <Bar dataKey="avg" radius={[4, 4, 0, 0]} maxBarSize={36} name="avg">
                    ...
                    {studentRanking.map((student) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-semibold">{student.avgScore}점</span>
                          {student.change !== 0 && (
                            <Badge
                              variant={student.change > 0 ? "default" : "destructive"}
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={attendanceData}>
                    ...
                    <YAxis domain={[0, 30]} tick={{ fontSize: 12 }} className="fill-muted-foreground" />
                    <Tooltip
                      contentStyle={{
                        background: "hsl(var(--card))",
                        border: "1px solid hsl(var(--border))",
                    ...
                    />
                    <Bar dataKey="attended" fill="#2ECC71" radius={[3, 3, 0, 0]} maxBarSize={20} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
