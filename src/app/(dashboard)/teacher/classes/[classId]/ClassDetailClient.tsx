...
const students = [
  { id: "s1", name: "김민준", streak: 15, todayCompleted: true, avgScore: 92, lastActive: "오늘 08:12" },
  { id: "s2", name: "이서연", streak: 12, todayCompleted: true, avgScore: 88, lastActive: "오늘 08:25" },
  { id: "s3", name: "박지호", streak: 3, todayCompleted: false, avgScore: 71, lastActive: "오늘 08:40" },
  { id: "s4", name: "최수아", streak: 8, todayCompleted: true, avgScore: 76, lastActive: "오늘 08:05" },
  { id: "s5", name: "정예준", streak: 0, todayCompleted: false, avgScore: 65, lastActive: "어제" },
  { id: "s6", name: "강하은", streak: 22, todayCompleted: true, avgScore: 95, lastActive: "오늘 08:18" },
  { id: "s7", name: "윤도윤", streak: 0, todayCompleted: false, avgScore: 58, lastActive: "3일 전" },
  { id: "s8", name: "임지유", streak: 7, todayCompleted: true, avgScore: 84, lastActive: "오늘 08:30" },
  { id: "s9", name: "한소율", streak: 5, todayCompleted: false, avgScore: 79, lastActive: "어제" },
  { id: "s10", name: "조서준", streak: 10, todayCompleted: true, avgScore: 87, lastActive: "오늘 07:55" },
];
...
const assignments = [
  { id: "a1", setTitle: "3학년 1학기 25일차", dueDate: "2026-02-28", completed: 18, total: 28 },
  { id: "a2", setTitle: "3학년 1학기 24일차", dueDate: "2026-02-27", completed: 24, total: 28 },
];
...
export default function ClassDetailClient() {
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText(`https://araharu.pages.dev/join/${classInfo.inviteCode}`);
    setCopiedLink(true);
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">
                  {classInfo.school} | {classInfo.grade}학년 {classInfo.semester}학기 | {classInfo.year}년
                </p>
              </div>
              ...
              <CardContent>
                <ScrollArea className="h-[400px]">
                  <div className="space-y-2">
                    {students
                      .sort((a, b) => (a.todayCompleted === b.todayCompleted ? b.avgScore - a.avgScore : a.todayCompleted ? -1 : 1))
                      .map((student, idx) => (
                        <Link
                          key={student.id}
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              <span className="text-sm font-medium">{student.avgScore}점</span>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={250}>
                    <LineChart data={weeklyData}>
                      ...
                      />
                      <Line type="monotone" dataKey="completion" stroke="#2ECC71" strokeWidth={2} name="완료율 (%)" dot={{ r: 3 }} />
                      <Line type="monotone" dataKey="avgScore" stroke="#4ECDC4" strokeWidth={2} name="평균점수" dot={{ r: 3 }} />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
