...
const childrenData = {
  child1: {
    ...
    subjectData: [
      ...
      { subject: "general_knowledge", name: "상식", accuracy: 90, color: "#F9CA24" },
    ],
  ...
  child2: {
    ...
    subjectData: [
      ...
      { subject: "general_knowledge", name: "상식", accuracy: 78, color: "#F9CA24" },
    ],
    calendarData: Array.from({ length: 90 }, (_, i) => {
      const date = subDays(new Date(), i);
...
export default function ParentReportsPage() {
  ...
  const chartData = period === "weekly" ? child.weeklyScores : child.monthlyScores;
      ...
      <main className="flex-1 pb-20 lg:pb-0">
        <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <Card>
                <CardContent className="pt-5 text-center">
                  ...
                  <p className="text-xl font-bold">{child.weekSummary.daysCompleted}/7일</p>
              ...
              <Card>
                <CardContent className="pt-5 text-center">
                  ...
                  <p className="text-xl font-bold">{child.weekSummary.avgScore}점</p>
              ...
              <Card>
                <CardContent className="pt-5 text-center">
                  ...
                  <p className={`text-xl font-bold ${child.weekSummary.improvement >= 0 ? "text-emerald-600" : "text-red-500"}`}>
              ...
              <Card>
                <CardContent className="pt-5 text-center">
                  ...
                  <p className="text-xl font-bold">{child.weekSummary.totalTime}분</p>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={280}>
                  <AreaChart data={chartData}>
                    <defs>
                      <linearGradient id="parentScoreGrad" x1="0" y1="0" x2="0" y2="1">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            >
              <SubjectChart data={child.subjectData} title={`${child.name} 과목별 정답률`} />
            </motion.div>
